...
// TX packet result
typedef enum {
    nRF24_TX_SUCCESS = (uint8_t)0x00,   // Packet transmitted successfully
    nRF24_TX_TIMEOUT = (uint8_t)0x01,   // It was timeout during packet transmit
    nRF24_TX_MAXRT   = (uint8_t)0x02,   // Transmit failed with maximum auto retransmit count
    nRF24_TX_ERROR   = (uint8_t)0x03,   // Some error happens
    nRF24_NO_IRQ     = (uint8_t)0x80    // No IRQ hapened
...
#define nRF24_TEST_ADDR         "TESTN"  // Fake address to test nRF24 presence
